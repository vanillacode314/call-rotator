...
const list_contact = sqliteTable(
	'list_contact',
	{
		listId: int('listId').references(() => lists.id, { onDelete: 'cascade' }),
...
const list_contactSchema = createSelectSchema(list_contact);
...
declare global {
	...
	type TListContact = z.TypeOf<typeof list_contactSchema>;
}
